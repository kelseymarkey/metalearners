...
```bash
run_sims.sh # in repo root directory
```
This will generate 30 samples of each simulation (A, C, and D). Each sample will contain 3000 rows in train, and 1000 rows in test.